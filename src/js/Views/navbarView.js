...
class NavbarView extends View {
	...
	updateTotalCount(data) {
		this._data = data;
		this._parentElement.querySelector(".totalCount").textContent = this._data;
	}
	_generateMarkup() {
	...
	<button class="toggle-mode">
		<svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" class="feather feather-moon hidden" ><path d="M21 12.79A9 9 0 1 1 11.21 3 7 7 0 0 0 21 12.79z"></path>
		</svg>	
		...
		<button class="openCart-btn w-10 relative">
		<span class="totalCount absolute right-0 text-xs w-6 h-6 flex justify-center items-center text-white border-red-500 rounded-full bg-red-500 right-4 bottom-2/4">${this._data}</span>
